...
Aalborg_NoThermonight <- read_excel("../Outputs/results_table_df_Aal_Nothermo.xlsx")
Aalborg_Thermonight <- read_excel("../Outputs/results_table_df_Aal_thermo.xlsx")
...
Granada_NoThermonight=read_excel("../Outputs/results_table_df_Gra_Nothermo.xlsx")
Granada_Thermonight=read_excel('../Outputs/results_table_df_Gra_thermo.xlsx')
...
sensimulti_Gra_Nothermo <- read_excel("../Outputs/sensi_multi_melt_Gra_Nothermo.xlsx")
sensimulti_Gra_thermo <- read_excel("../Outputs/sensi_multi_melt_Gra_thermo.xlsx")
...
sensimulti_Aal_Nothermo <- read_excel("../Outputs/sensi_multi_melt_Aal_Nothermo.xlsx")
sensimulti_Aal_thermo <- read_excel("../Outputs/sensi_multi_melt_Aal_thermo.xlsx")
...
# Load data
contrib_Aal_thermo <- read.csv(file="../Outputs/all_methods_contribution_df_melted_Aal_thermo.csv",sep=';',header=FALSE)
contrib_Aal_Nothermo <- read.csv(file="../Outputs/all_methods_contribution_df_melted_Aal_Nothermo.csv",sep=';',header=FALSE)
contrib_Gra_Nothermo <- read.csv(file="../Outputs/all_methods_contribution_df_melted_Gra_Nothermo.csv",sep=';',header=FALSE)
contrib_Gra_thermo <- read.csv(file="../Outputs/all_methods_contribution_df_melted_Gra_thermo.csv",sep=';',header=FALSE)
