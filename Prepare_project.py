...
'''
Creating a project 'Microalgae_Sim' with biosphere3, importing Ecoinvent 3.6 consequential and
...
database_dict=import_database_data_from_json('Microalgae_foreground','Microalgae_foreground')
