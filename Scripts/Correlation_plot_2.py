...
#Granada
Granada_thermonight = pd.read_excel("../Outputs/results_table_df_Gra_thermo.xlsx",index_col=0)
Granada_Nothermonight = pd.read_excel("../Outputs/results_table_df_Gra_Nothermo.xlsx",index_col=0)

#Aalborg
Aalborg_thermonight = pd.read_excel("../Outputs/results_table_df_Aal_thermo.xlsx",index_col=0)
Aalborg_Nothermonight = pd.read_excel("../Outputs/results_table_df_Aal_Nothermo.xlsx",index_col=0)
...
plt.savefig('../Plot/heatmap,Granada,No thermoregulation at night.png', dpi=500, bbox_inches='tight')
...
plt.savefig('../Plot/heatmap,Granada, Thermoregulation at night.png', dpi=300, bbox_inches='tight')
...
plt.savefig('../Plot/heatmap,Aalborg, Thermoregulation at night.png', dpi=300, bbox_inches='tight')
...
plt.savefig('../Plot/heatmap,Aalborg, NoThermoregulation at night.png', dpi=300, bbox_inches='tight')
