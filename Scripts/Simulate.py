...
INSTRUCTIONS :
    ...
    -Execute the whole script without modification (Run current cell) and wait .
...
all_methods_contribution_df_melted_Aal_Nothermo.to_csv('../Outputs/all_methods_contribution_df_melted_Aal_Nothermo.csv', sep=';', encoding='utf-8')
...
results_table_df_Aal_Nothermo.to_excel('../Outputs/results_table_df_Aal_Nothermo.xlsx',
                          sheet_name='Sheet1',
                          na_rep='',
                          float_format=None,
                          columns=None,
...
sensi_multi_melt_Aal_Nothermo.to_excel('../Outputs/sensi_multi_melt_Aal_Nothermo.xlsx', 
              sheet_name='Sheet1',
              na_rep='', 
              float_format=None,
              columns=None,
...
desc_LCI_Aal_Nothermo.to_excel('../Outputs/desc_LCI_Aal_Nothermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
desc_contributions_Aal_Nothermo.to_excel('../Outputs/desc_contributions_Aal_Nothermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
result_LCI_rescaled_Aal_Nothermo.to_excel('../Outputs/result_LCI_rescaled_Aal_Nothermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
all_methods_contribution_df_melted_Aal_thermo.to_csv('../Outputs/all_methods_contribution_df_melted_Aal_thermo.csv', sep=';', encoding='utf-8')
...
results_table_df_Aal_thermo.to_excel('../Outputs/results_table_df_Aal_thermo.xlsx',
                          sheet_name='Sheet1',
                          na_rep='',
                          float_format=None,
                          columns=None,
...
sensi_multi_melt_Aal_thermo.to_excel('../Outputs/sensi_multi_melt_Aal_thermo.xlsx', 
              sheet_name='Sheet1',
              na_rep='', 
              float_format=None,
              columns=None,
...
desc_LCI_Aal_thermo.to_excel('../Outputs/desc_LCI_Aal_thermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
desc_contributions_Aal_thermo.to_excel('../Outputs/desc_contributions_Aal_thermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
result_LCI_rescaled_Aal_thermo.to_excel('../Outputs/result_LCI_rescaled_Aal_thermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
all_methods_contribution_df_melted_Gra_Nothermo.to_csv('../Outputs/all_methods_contribution_df_melted_Gra_Nothermo.csv', sep=';', encoding='utf-8')
...
results_table_df_Gra_Nothermo.to_excel('../Outputs/results_table_df_Gra_Nothermo.xlsx',
                          sheet_name='Sheet1',
                          na_rep='',
                          float_format=None,
                          columns=None,
...
sensi_multi_melt_Gra_Nothermo.to_excel('../Outputs/sensi_multi_melt_Gra_Nothermo.xlsx', 
              sheet_name='Sheet1',
              na_rep='', 
              float_format=None,
              columns=None,
...
desc_LCI_Gra_Nothermo.to_excel('../Outputs/desc_LCI_Gra_Nothermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
desc_contributions_Gra_Nothermo.to_excel('../Outputs/desc_contributions_Gra_Nothermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
result_LCI_rescaled_Gra_Nothermo.to_excel('../Outputs/result_LCI_rescaled_Gra_Nothermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
all_methods_contribution_df_melted_Gra_thermo.to_csv('../Outputs/all_methods_contribution_df_melted_Gra_thermo.csv', sep=';', encoding='utf-8')
...
results_table_df_Gra_thermo.to_excel('../Outputs/results_table_df_Gra_thermo.xlsx',
                          sheet_name='Sheet1',
                          na_rep='',
                          float_format=None,
                          columns=None,
...
sensi_multi_melt_Gra_thermo.to_excel('../Outputs/sensi_multi_melt_Gra_thermo.xlsx', 
              sheet_name='Sheet1',
              na_rep='', 
              float_format=None,
              columns=None,
...
desc_LCI_Gra_thermo.to_excel('../Outputs/desc_LCI_Gra_thermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
desc_contributions_Gra_thermo.to_excel('../Outputs/desc_contributions_Gra_thermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
...
result_LCI_rescaled_Gra_thermo.to_excel('../Outputs/result_LCI_rescaled_Gra_thermo.xlsx', 
             sheet_name='Sheet1',
             na_rep='', 
             float_format=None,
             columns=None,
