...
Execute the whole script (with Run current cell,  to plot for algae with 2 different compositions (cf SI I).
...
fishfeed_table = pd.read_csv("../Data/Feed_composition.csv",sep=";",header=0,encoding = 'unicode_escape', engine ='python')
...
plt.savefig('../Plot/Optimization_substitution_Alga 1',dpi=600)
...
plt.legend(fontsize=8,loc='best')
plt.savefig('../Plot/Optimization_substituion_Alga2',dpi=600)
