...
# Change name accordingly ( July/November)

plt.savefig('../Plot/hconvinfluence_heating_november.png',dpi=300, bbox_inches='tight')
...
plt.savefig('../Plot/hconvinfluence_cooling_november.png',dpi=300, bbox_inches='tight')
...
# Change name accordingly ( July/November)
plt.savefig('../Plot/No_thermo_at_night_november.png',dpi=300, bbox_inches='tight')
